...
import { 
  LayoutDashboard, Calendar, FileSpreadsheet, Settings, LogOut, Menu, X, Shield 
} from 'lucide-react';
...
export const AdminLayout: React.FC = () => {
  ...
  const menuItems = [
    { name: 'Dashboard Analytics', path: '/admin/dashboard', icon: <LayoutDashboard className="h-4.5 w-4.5" /> },
    { name: 'Weekly Schedule', path: '/admin/schedule', icon: <Calendar className="h-4.5 w-4.5" /> },
    { name: 'Google Sheets Live', path: '/admin/sheets', icon: <FileSpreadsheet className="h-4.5 w-4.5" /> },
    { name: 'Clinic Settings', path: '/admin/settings', icon: <Settings className="h-4.5 w-4.5" /> },
  ];
      ...
      >
        <div className="space-y-8">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] text-slate-500 font-mono tracking-wider uppercase mt-0.5">Admin Portal</p>
            </div>
          </div>
        ...
        <div className="pt-4 border-t border-slate-800/60 flex items-center justify-between">
          <div className="overflow-hidden">
            ...
            <p className="text-[9px] text-slate-500 font-mono tracking-wider uppercase">System Administrator</p>
          </div>
          <button
